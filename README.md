# @erboladaiorg/maiores-nesciunt-molestias
...
If you require this package's `@erboladaiorg/maiores-nesciunt-molestias/register` module it will read the `paths` from `tsconfig.json` or `jsconfig.json` and convert node's module loading calls into to physical file paths that node can load.

## How to install

```
yarn add --dev @erboladaiorg/maiores-nesciunt-molestias
```

or

```
npm install --save-dev @erboladaiorg/maiores-nesciunt-molestias
```
...
`node -r @erboladaiorg/maiores-nesciunt-molestias/register main.js`

If `process.env.TS_NODE_BASEURL` is set it will override the value of `baseUrl` in tsconfig.json:

`TS_NODE_BASEURL=./dist node -r @erboladaiorg/maiores-nesciunt-molestias/register main.js`

### With ts-node

`ts-node -r @erboladaiorg/maiores-nesciunt-molestias/register main.ts`

If `process.env.TS_NODE_PROJECT` is set it will be used to resolved tsconfig.json

### With webpack

For webpack please use the [@erboladaiorg/maiores-nesciunt-molestias-webpack-plugin](https://github.com/erboladaiorg/maiores-nesciunt-molestias-webpack-plugin).
...
```bash
mocha -r ts-node/register -r @erboladaiorg/maiores-nesciunt-molestias/register "test/**/*.ts"
```

### With other commands

As long as the command has something similar to a `--require` option that can load a module before it starts, @erboladaiorg/maiores-nesciunt-molestias should be able to work with it.
  ...
  "configurations": [
    {
      ...
      "runtimeArgs": [
        ...
        "-r",
        "${workspaceFolder}/functions/node_modules/@erboladaiorg/maiores-nesciunt-molestias/register"
      ],
...
If you want more granular control over @erboladaiorg/maiores-nesciunt-molestias you can bootstrap it. This can be useful if you for instance have compiled with `tsc` to another directory where `tsconfig.json` doesn't exists.

For example, create a wrapper script called `@erboladaiorg/maiores-nesciunt-molestias-bootstrap.js` with the contents below:

```javascript
const tsConfig = require("./tsconfig.json");
const tsConfigPaths = require("@erboladaiorg/maiores-nesciunt-molestias");
...
`node -r ./@erboladaiorg/maiores-nesciunt-molestias-bootstrap.js main.js`
...
```bash
ts-node --project customLocation/tsconfig.json -r @erboladaiorg/maiores-nesciunt-molestias/register "test/**/*.ts"
```
...
[version-image]: https://img.shields.io/npm/v/@erboladaiorg/maiores-nesciunt-molestias.svg?style=flat
[version-url]: https://www.npmjs.com/package/@erboladaiorg/maiores-nesciunt-molestias
[build-image]: https://github.com/erboladaiorg/maiores-nesciunt-molestias/workflows/CI/badge.svg
[build-url]: https://github.com/erboladaiorg/maiores-nesciunt-molestias/actions/workflows/ci.yml?query=branch%3Amaster
[codecov-image]: https://codecov.io/gh/dividab/@erboladaiorg/maiores-nesciunt-molestias/branch/master/graph/badge.svg
[codecov-url]: https://codecov.io/gh/dividab/@erboladaiorg/maiores-nesciunt-molestias
[license-image]: https://img.shields.io/github/license/dividab/@erboladaiorg/maiores-nesciunt-molestias.svg?style=flat
